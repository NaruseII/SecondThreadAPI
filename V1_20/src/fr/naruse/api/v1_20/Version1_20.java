...
public class Version1_20 implements IVersion {
    ...
    public void moveEntityToDestination(Entity entity, Location destination, double speed) {
        try{
            ...
            NavigationAbstract navigationAbstract = (NavigationAbstract) entityInsentient.getClass().getMethod("J").invoke(entityInsentient);
