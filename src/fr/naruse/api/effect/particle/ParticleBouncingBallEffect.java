...
public class ParticleBouncingBallEffect extends ParticleEffect implements IParticleEffect{
    ...
    public ParticleBouncingBallEffect(Location center, double radius, int particleAmountPerLine, RotationData rotationData, IParticle particle) {
        this.center = center;
